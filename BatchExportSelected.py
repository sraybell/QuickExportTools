...
import os  # pylint: disable=import-error, wrong-import-position, wrong-import-order
...
PROPS = [
    ('export_normals_chk', bpy.props.BoolProperty(
        name='Include Normals', default=False)),
    ('export_uvs_chk', bpy.props.BoolProperty(name='Include UVs', default=False)),
    ('export_materials_chk', bpy.props.BoolProperty(name='Export Materials (.mtl)',
     default=False, description='Exports an associated .mtl')),
    ('apply_modifiers_chk', bpy.props.BoolProperty(name='Apply Modifiers',
